...
arboleda = leer_arboles(nombre_archivo)
altos=[float(arbol['altura_tot']) for arbol in arboleda if arbol['nombre_com']=='Eucalipto']
diam=[float(arbol['diametro']) for arbol in arboleda if arbol['nombre_com']=='Eucalipto']
d=np.array(diam)
h=np.array(altos)
